...
public interface API {
    ...
    /**
     * Ping service. Simply returns the number of milliseconds since engine boot, or 0 if engine is
     * not running. Accepts HEAD requests to simply check for heartbeat.
     * 
     * <p>
     ...
     * management but only Websockets clients can access it.
     * 
     * @author Ferd
     *
     */
