...
public class Concept extends Knowledge implements IConcept {
    ...
    public boolean is(ISemantic s) {
        ...
        // IConcept authc =
        // KLAB.c(concept.getMetadata().getString(NS.AUTHORITY_BASE_CONCEPT));
        // if (authc != null) {
...
//        System.out.println("Does " + resolving + " resolve " + resolved + "?");
        ...
        component = getDistance(Observables.INSTANCE.getCooccurrentType(this), Observables.INSTANCE.getCooccurrentType(concept),
                false);
        ...
        component = getDistance(Observables.INSTANCE.getCausantType(this), Observables.INSTANCE.getCausantType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getAdjacentType(this), Observables.INSTANCE.getAdjacentType(concept), false);
        ...
        component = getDistance(Observables.INSTANCE.getCompresentType(this), Observables.INSTANCE.getCompresentType(concept),
                false);
        ...
        component = getDistance(Observables.INSTANCE.getComparisonType(this), Observables.INSTANCE.getComparisonType(concept),
                false);
