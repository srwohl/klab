...
public class ModelKbox extends ObservableKbox {
	...
	public List<ModelReference> queryModels(IObservable observable, ResolutionScope context) throws KlabException {
		...
		Logging.INSTANCE.info(
				"model query for " + (context.getMode() == Mode.INSTANTIATION ? "instantiation of " : "explanation of ")
	...
	// public static String generateObjectModelSource(IConcept observable, String
	// objectSource,
